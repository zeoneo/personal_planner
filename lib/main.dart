...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Daily Planner'),
    );
  }
}
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              selected: _selectedPlanner == 0,
              onTap: () {
                _setSelectedPlanner(0);
                Navigator.pop(context);
              },
            ),
            ListTile(
              title: Text('Monthly Planner'),
              selected: _selectedPlanner == 1,
              onTap: () {
                _setSelectedPlanner(1);
                Navigator.pop(context);
              },
            ),
            ListTile(
              title: Text('Annual Planner'),
              selected: _selectedPlanner == 2,
              onTap: () {
                _setSelectedPlanner(2);
                Navigator.pop(context);
              },
            ),
          ],
